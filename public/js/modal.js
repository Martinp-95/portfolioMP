...
// When the user clicks the button, open the modal 
 function InformationSoc(nom) {
    ...
    if(nom == "ETNIC"){
      ...
      modalBody.innerHTML = `<img style="width: 100%; height: 100%;" src="../img/Conference_Cognizant.PNG" alt="conference" />`;
      modalFooter.innerHTML = `Portfolio`;
    }else if(nom == "Efficy") {
      titreHeader.innerHTML = `Conférence ${nom}`;
      modalBody.innerHTML = `<img style="width: 100%; height: 100%;" src="public/img/Conférence_Efficy.png" alt="conference" />`;
      modalFooter.innerHTML = `Portfolio`;
    }else if(nom == "Everis") {
      titreHeader.innerHTML = `Conférence ${nom}`;
